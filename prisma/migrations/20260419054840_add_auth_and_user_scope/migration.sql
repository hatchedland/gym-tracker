...
*/
-- DropIndex
DROP INDEX "workout_sessions_day_completed_at_idx";

-- DropIndex
DROP INDEX "workout_sessions_started_at_idx";
...
-- CreateIndex
CREATE INDEX "workout_sessions_user_id_day_completed_at_idx" ON "workout_sessions"("user_id", "day", "completed_at");
